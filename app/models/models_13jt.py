...
class Jingjibiao(Base):
    __tablename__ = 'jingjibiao'
    __table_args__ = (
...
class Dxgcxx(Base):
    ...
    file_id: Mapped[Optional[int]] = mapped_column(ForeignKey('file.id'))
    jingjibiao_id: Mapped[Optional[int]] = mapped_column(ForeignKey('jingjibiao.id'))
...
class Toubiaoxx(Base):
    __tablename__ = 'toubiaoxx'
    __table_args__ = (
...
class Dwgcxx(Base):
    ...
    file_id: Mapped[Optional[int]] = mapped_column(ForeignKey('file.id'))
    jingjibiao_id: Mapped[Optional[int]] = mapped_column(ForeignKey('jingjibiao.id'))
    dxgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dxgcxx.id'))
...
class Cbrgycl(Base):
    ...
    jingjibiao_id: Mapped[Optional[int]] = mapped_column(ForeignKey('jingjibiao.id'))
    dxgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dxgcxx.id'))
    dwgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dwgcxx.id'))
...
class Zjxmjdkzffj(Base):
    __tablename__ = 'zjxmjdkzffj'
    __table_args__ = (
...
class Djcs(Base):
    ...
    dxgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dxgcxx.id'))
    dwgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dwgcxx.id'))
    csxm_id: Mapped[Optional[int]] = mapped_column(ForeignKey('csxm.id'))
...
class Fywjmx(Base):
    ...
    dxgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dxgcxx.id'))
    dwgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dwgcxx.id'))
    fywj_id: Mapped[Optional[int]] = mapped_column(ForeignKey('fywj.id'))
...
class Gfsjmx(Base):
    ...
    dxgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dxgcxx.id'))
    dwgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dwgcxx.id'))
    gfsj_id: Mapped[Optional[int]] = mapped_column(ForeignKey('gfsj.id'))
...
class Jrgbt(Base):
    ...
    dxgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dxgcxx.id'))
    dwgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dwgcxx.id'))
    jrg_id: Mapped[Optional[int]] = mapped_column(ForeignKey('jrg.id'))
...
class Qdbt(Base):
    ...
    dxgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dxgcxx.id'))
    dwgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dwgcxx.id'))
    qdxm_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdxm.id'))
...
class Qtxmmx(Base):
    ...
    dxgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dxgcxx.id'))
    dwgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dwgcxx.id'))
    qtxm_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qtxm.id'))
...
class Rcjhzmx(Base):
    ...
    dxgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dxgcxx.id'))
    dwgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dwgcxx.id'))
    rcjhz_id: Mapped[Optional[int]] = mapped_column(ForeignKey('rcjhz.id'))
...
class Zjxmjdkzffjmx(Base):
    __tablename__ = 'zjxmjdkzffjmx'
    __table_args__ = (
    ...
    dxgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dxgcxx.id'))
    dwgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dwgcxx.id'))
    zjxmjdkzffj_id: Mapped[Optional[int]] = mapped_column(ForeignKey('zjxmjdkzffj.id'))
...
class Zljemx(Base):
    ...
    dxgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dxgcxx.id'))
    dwgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dwgcxx.id'))
    zlje_id: Mapped[Optional[int]] = mapped_column(ForeignKey('zlje.id'))
...
class Djcsmx(Base):
    ...
    mc: Mapped[Optional[str]] = mapped_column(String(100))
    xmtz: Mapped[Optional[str]] = mapped_column(String(100))
    jsgz: Mapped[Optional[str]] = mapped_column(String(100))
    dw: Mapped[Optional[str]] = mapped_column(String(100))
    sl: Mapped[Optional[str]] = mapped_column(String(100))
    ...
    dwgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dwgcxx.id'))
    csxm_id: Mapped[Optional[int]] = mapped_column(ForeignKey('csxm.id'))
    djcs_id: Mapped[Optional[int]] = mapped_column(ForeignKey('djcs.id'))
...
class Qdmx(Base):
    ...
    dwgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dwgcxx.id'))
    qdxm_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdxm.id'))
    qdbt_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdbt.id'))
...
class Zfmx(Base):
    ...
    dwgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dwgcxx.id'))
    zjxmjdkzffj_id: Mapped[Optional[int]] = mapped_column(ForeignKey('zjxmjdkzffj.id'))
    zjxmjdkzffjmx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('zjxmjdkzffjmx.id'))
...
class Zjcsmx(Base):
    ...
    dwgcxx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('dwgcxx.id'))
    csxm_id: Mapped[Optional[int]] = mapped_column(ForeignKey('csxm.id'))
    zjcs_id: Mapped[Optional[int]] = mapped_column(ForeignKey('zjcs.id'))
...
class Aqwmfmx(Base):
    ...
    csxm_id: Mapped[Optional[int]] = mapped_column(ForeignKey('csxm.id'))
    zjcs_id: Mapped[Optional[int]] = mapped_column(ForeignKey('zjcs.id'))
    zjcsmx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('zjcsmx.id'))
...
class Csxdezj(Base):
    ...
    csxm_id: Mapped[Optional[int]] = mapped_column(ForeignKey('csxm.id'))
    djcs_id: Mapped[Optional[int]] = mapped_column(ForeignKey('djcs.id'))
    djcsmx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('djcsmx.id'))
...
class Qdxdezj(Base):
    ...
    qdxm_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdxm.id'))
    qdbt_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdbt.id'))
    qdmx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdmx.id'))
...
class Csxdezjmx(Base):
    __tablename__ = 'csxdezjmx'
    __table_args__ = (
    ...
    djcs_id: Mapped[Optional[int]] = mapped_column(ForeignKey('djcs.id'))
    djcsmx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('djcsmx.id'))
    csxdezj_id: Mapped[Optional[int]] = mapped_column(ForeignKey('csxdezj.id'))
...
class Csxrcjhlmx(Base):
    __tablename__ = 'csxrcjhlmx'
    __table_args__ = (
    ...
    djcs_id: Mapped[Optional[int]] = mapped_column(ForeignKey('djcs.id'))
    djcsmx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('djcsmx.id'))
    csxrcjhl_id: Mapped[Optional[int]] = mapped_column(ForeignKey('csxrcjhl.id'))
...
class Qdxdezjmx(Base):
    __tablename__ = 'qdxdezjmx'
    __table_args__ = (
    ...
    qdbt_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdbt.id'))
    qdmx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdmx.id'))
    qdxdezj_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdxdezj.id'))
...
class Qdxrcjhlmx(Base):
    __tablename__ = 'qdxrcjhlmx'
    __table_args__ = (
    ...
    qdbt_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdbt.id'))
    qdmx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdmx.id'))
    qdxrcjhl_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdxrcjhl.id'))
...
class Csxdercjhl(Base):
    __tablename__ = 'csxdercjhl'
    __table_args__ = (
    ...
    djcsmx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('djcsmx.id'))
    csxdezj_id: Mapped[Optional[int]] = mapped_column(ForeignKey('csxdezj.id'))
    csxdezjmx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('csxdezjmx.id'))
...
class Qdxdercjhl(Base):
    __tablename__ = 'qdxdercjhl'
    __table_args__ = (
    ...
    qdmx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdmx.id'))
    qdxdezj_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdxdezj.id'))
    qdxdezjmx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdxdezjmx.id'))
...
class Csxdercjhlmx(Base):
    __tablename__ = 'csxdercjhlmx'
    __table_args__ = (
    ...
    csxdezj_id: Mapped[Optional[int]] = mapped_column(ForeignKey('csxdezj.id'))
    csxdezjmx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('csxdezjmx.id'))
    csxdercjhl_id: Mapped[Optional[int]] = mapped_column(ForeignKey('csxdercjhl.id'))
...
class Qdxdercjhlmx(Base):
    __tablename__ = 'qdxdercjhlmx'
    __table_args__ = (
    ...
    qdxdezj_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdxdezj.id'))
    qdxdezjmx_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdxdezjmx.id'))
    qdxdercjhl_id: Mapped[Optional[int]] = mapped_column(ForeignKey('qdxdercjhl.id'))
